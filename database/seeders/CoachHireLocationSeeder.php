...
class CoachHireLocationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($this->locations() as $index => $location) {
            ...
            // stored under storage/app/public/coach-hire-locations. Only wire it
            // up if the file is actually present, so a checkout without the
            // images falls back cleanly to the gradient hero. The admin can
            // replace any photo (and its credit) from the panel.
            $credit = $credits[$slug] ?? null;
            $heroImage = null;
            if (Storage::disk('public')->exists("coach-hire-locations/{$slug}.webp")) {
                $heroImage = "coach-hire-locations/{$slug}.webp";
            }
    ...
    /**
     * Photo attribution + alt text collected when the hero images were fetched
     * from Wikimedia Commons. Keyed by slug. Returns [] if the file is missing.
     */
    ...
    private function locations(): array
    {
        return [
            [
                'name' => 'London',
                'meta_title' => 'Coach Hire London | Executive Coaches & Minibus Hire — Brit Travels',
            ...
            [
                'name' => 'Glasgow',
                'meta_title' => 'Coach Hire Glasgow | Minibus & Coach Hire with Driver — Brit Travels',
            ...
            [
                'name' => 'Edinburgh',
                'meta_title' => 'Coach Hire Edinburgh | Festival, Rugby & Airport Coach Hire — Brit Travels',
            ...
            [
                ...
                'meta_title' => 'Coach Hire Newcastle | Minibus & Coach Hire with Driver — Brit Travels',
